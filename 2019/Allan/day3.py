...
collisions = []
bestcollision = 99999999
bestpoint = ""
for ln in range(len(lines)-1):
    for point in lines[ln]:
        if point in lines[ln+1]:
            collisions.append(point)
def getmanhattan(point1, point2):
    return(abs(point1[0]-point2[0]))+abs((point1[1]-point2[1]))
for i in collisions:
    distance = getmanhattan([0,0],i)
    if distance < bestcollision and i != [0,0]:
        bestcollision = distance
        bestpoint = i
print(bestpoint, bestcollision)