...
namespace AoC2019
{
    public class Day2
    {
        public void Run()
        {
            ...
            Console.WriteLine("Day 02,P1:" + i.IntCodeInstructions[0] + ", completed in " + (System.DateTime.Now - begin).TotalMilliseconds + " milliseconds");
            int x = -1;
