...
namespace AoC2019
{
    public class MerryChristmas
    {
        ...
        public void Run()
        {
            ...
            var i = new IntCode(Data, ProvideInputPart1);
            do
            {
                result = i.Run(RunningMode.OutputAttached);
                while (i.Output.Count != 0)
                {
                    Console.Write((char)i.Output.Dequeue());
                }
            } while (result == false);
            begin = DateTime.Now;
            result = false;
