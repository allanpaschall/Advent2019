                ...
                foreach (var op in line.Split(','))
                {
                    ...
                    switch (op[0])
                    {
                        case 'R':
                            ...
                            {
                                CurrentPoint.X += 1;
                                IterateStep(intersections, Line1Points, points, CurrentPoint);
                            }
                            break;
                        case 'D':
