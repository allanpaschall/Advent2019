...
namespace AoC2019
{
    public class Day11
    {
        ...
        public void Run()
        {
            Console.WriteLine("Day 11,P1:" + (from p in RunPainter(0) where p != 0 select p).Count());
            ...
            //    Console.WriteLine();
            //}
            Console.WriteLine("Day 11,P2:" + CharacterOCR.ReturnCharacters(Input, 8, 2));
