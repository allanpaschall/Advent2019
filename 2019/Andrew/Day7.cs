...
namespace AoC2019
{
    public class Day7
    {
        ...
        public void Part1()
        {
            ...
            List<long> attempts2 = new List<long>();
            ...
            Console.WriteLine("Day 07,P1:" + (from att in attempts2 orderby att descending select att).First() + ", completed in " + (System.DateTime.Now - begin).TotalMilliseconds + " milliseconds");
        }
        public void Part2()
        {
            var begin = System.DateTime.Now;
            ...
            Console.WriteLine("Day 07,P2:" + (from att in attempts2 orderby att descending select att).First() + ", completed in " + (System.DateTime.Now - begin).TotalMilliseconds + " milliseconds");
        }
