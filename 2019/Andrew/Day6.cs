...
namespace AoC2019
{
    public class Orbitor
    {
        public Orbitor()
        {
            Children = new List<Orbitor>();
        }
        public Orbitor Parent { get; set; }
        public string Name { get; set; }
        public List<Orbitor> Children { get; set; }
        public int Paths
        {
            get
            {
    ...
    public class Day6
    {
        ...
        public void Run()
        {
            ...
            foreach (var item in lists)
            {
                ...
                {
                    dict[p[0]] = new Orbitor() { Name = p[0] };
                }
                if (!dict.ContainsKey(p[1]))
                {
                    dict[p[1]] = new Orbitor() { Name = p[1] };
                }
                dict[p[0]].Children.Add(dict[p[1]]);
                dict[p[1]].Parent = dict[p[0]];
            }
            int i = 0;
        ...
        public static string TestData = @"COM)B
B)C
C)D
D)E
E)F
...
I)SAN";
        ...
        public static string Data = @"YMK)12Q
N3N)11S
P73)8Q3
PC8)14H
CDH)SR2
